...
public class RandomHelper {
    ...
    static int FindLegalMoves(RandomState state) {
        int x, y;
    ...
    public static void main(String argv[]) throws Exception {
        ...
        //RandomHelper stupid = new RandomHelper();
        play(argv);
    }
    ...
    public static void play(String argv[]) throws Exception {
        ...
        if (player1 == 1) {
            ...
            RandomPlayer.FindBestMove(1,board,bestmove);
            ...
            RandomPlayer.FindBestMove(2,board,bestmove);
            if (bestmove[0] != 0) { /* There is a legal move */
                mlen = MoveLength(bestmove);
                PerformMove(board, bestmove, mlen);
                buf = MoveToText(bestmove);
